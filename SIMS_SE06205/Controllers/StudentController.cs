...
namespace SIMS_SE06205.Controllers
{
    ...
    {
        private string filePathStudent = @"D:\Course Applied Programming\APDP-BTec-main (1)\data-sims\data-student.json";
        private string filePathCourse = @"D:\Course Applied Programming\APDP-BTec-main (1)\data-sims\data-courses.json";
        private string filePathClass = @"D:\Course Applied Programming\APDP-BTec-main (1)\data-sims\class.json";
        ...
        public IActionResult Update(int id)
        {
            try
            {
                ...
                {
                    ViewBag.CourseList = GetCourseList();
                    ViewBag.ClassList = GetClassList();  // Passing a list of layers into ViewBag
                    ...
                    var studentModel = new StudentViewModel
                    {
                        ...
                        Class = itemStudent.Class  // Get class value from data
                    };
        ...
        public void SetStudentData(string studentJson)
        {
